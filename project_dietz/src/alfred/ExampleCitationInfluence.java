 ...
 */
public class ExampleCitationInfluence {
...
//        System.out.println("alphaGamma="+alphaGamma);
        ...
        NewData nd = new NewData(pubId2CiteIds, id2Docs, tnum, cnum, alphaPhi, alphaPsi, alphaTheta, alphaLambdaInherit, alphaLambdaInnov, alphaGamma);
...
//        
//        for(Integer i: pubId2CiteIds.keySet()){
//    		System.out.println();
//    		System.out.println("citation mixture id " + i + ": " +sampwrap.getGammaForPubId(i));
//    		System.out.println("degree of innovation for " + i + ": " + sampwrap.getLambdaDistrForPubId(i));
//        	for(Integer j : id2Docs.keySet()){
//                System.out.println("topic mixture for id " + j + ": " + sampwrap.getThetaByPubId(j));
//        	}
//        }
//        
//        
