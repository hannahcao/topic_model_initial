...
/**
 */
public class CitinfWrapperR11 implements Serializable, ITopicModelWrapper {
    ...
    public CitinfWrapperR11(Map<Integer, List<Integer>> pubId2CiteIds, Map<Integer, IDocument> pubId2Docs, int numTopics, int numCites, double alphaPhi, double alphaPsi, double alphaTheta, double alphaLambdaInherit, double alphaLambdaInnov, double alphaGamma) {
            ...
            Thread thread = new Thread(new Runnable() {
                public void run() {
                    ...
                    if (takeSamplesFromThisChain) {
                        CitinfWrapperR11.this.sampler = sampler;
                    }
